...
///         within the protocol.
/// @dev The Registry Interface is used to interact with the protocol and create profiles
///      that can be used to interact with the protocol. The Registry is the main contract
