  ...
  },
  {
    ...
    async setAdmin(params: { args: { _newAdmin: string }, value?: bigint, gasPrice?: bigint }): Promise<TransactionReceipt> {
    ...
    async setClaimsManager(params: { args: { account: string }, value?: bigint, gasPrice?: bigint }): Promise<TransactionReceipt> {
      if (!this.walletClient) {
        throw new Error('Wallet client is required for write operations.');
      }
    ...
    async setClaimsToken(params: { args: { _claimsToken: string }, value?: bigint, gasPrice?: bigint }): Promise<TransactionReceipt> {
      if (!this.walletClient) {
        throw new Error('Wallet client is required for write operations.');
      }
    ...
    async setImplementation(params: { args: { _newImplementation: string }, value?: bigint, gasPrice?: bigint }): Promise<TransactionReceipt> {
      if (!this.walletClient) {
        throw new Error('Wallet client is required for write operations.');
      }
