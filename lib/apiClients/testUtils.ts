...
async function testAdminMode() {
  ...
  await contractClient
    .registerBuilderToken({ args: { builderId: 'fc70e8f8-e35e-4a98-9a84-b34f99b32196' }, gasPrice: BigInt(4e7) })
    .then(console.log);
}
...
async function test() {
  ...
  await contractClient
    .mintBuilderNft({ args: { tokenId: BigInt(1), amount: BigInt(1), scout: '0c3c75bc-dae0-487d-947e-0b780a38988d' } })
    .then(console.log);
}

usdcClient
  .allowance({
    args: { owner: '0x2523Cd8d1f401D07b257BF488C56aeB4Ef72d8f0', spender: '0xc6534d33bc65e319fb082e82c0b56bd4d9854aaf' }
  })
  .then(console.log);
