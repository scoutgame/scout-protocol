...
task('deployStargateProtocol', 'Deploys the StargateProtocol contract')
  .setAction(async (taskArgs, hre) => {
    ...
    fs.writeFileSync(path.resolve(__dirname, '..', 'abis', 'StargateProtocol.json'), JSON.stringify(contractABI, null, 2));
  });
